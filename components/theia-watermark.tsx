...
export function TheiaWatermark() {
  return (
    <div
      className="pointer-events-none fixed bottom-0 right-0 z-0 opacity-[0.03] select-none"
      aria-hidden="true"
    >
      <svg
        viewBox="0 0 300 300"
        xmlns="http://www.w3.org/2000/svg"
        className="h-[500px] w-[500px] translate-x-[80px] translate-y-[60px] text-foreground"
      >
