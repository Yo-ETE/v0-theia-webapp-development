...
import { Bell, BellOff, Battery, Signal, Wifi, WifiOff, Check, X } from "lucide-react"
...
export function NotificationBell() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-10 z-50 w-80 max-h-96 overflow-hidden rounded-lg border border-border bg-popover shadow-xl">
          {/* Header */}
